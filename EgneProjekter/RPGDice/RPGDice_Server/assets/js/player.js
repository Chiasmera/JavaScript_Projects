...
const statColours = {
    str: ['images/str.png', diceColours.red],
    dex:['images/dex.png', diceColours.teal],
    con:['images/end.png', diceColours.green],
    int:['images/int.png', diceColours.blue],
    wis:['images/wis.png', diceColours.purple],
    cha:['images/cha.png', diceColours.yellow],
...
class Action {
    ...
    calcResult = function () {
        ...
        if ( luckRoll >= 0.95 || attemptValue >= this.difficulty + 10){
            //critical success
            this.result = 'Great Success!'
        } else if (luckRoll < 0.05 || attemptValue<= this.difficulty - 10 ) {
            //Great failure
